...
function keyboardInput(event) {
    ...
    // PRESS UP ARROW
        ...
        if (currentCardIndex > (numberOfCards() / 3)) {
            var newIndex_2 = "" + (currentCardIndex - (numberOfCards() / 3));
            window.setTimeout(function () {
    ...
    // PRESS DOWN ARROW
        ...
        if (currentCardIndex < lastCardIndex() - (numberOfCards() / 3 - 1)) {
            var newIndex_4 = "" + (currentCardIndex + (numberOfCards() / 3));
            window.setTimeout(function () {
...
var pushCardsBack = function () {
    var cellWithoutCard = document.querySelectorAll(".cell:empty");
    for (var i = 12; i <= 14; i++) {
    }
};
var handleAddRow = function () {
    ...
    setTimeout(function () { return fillSpots(stack, board); }, 700);
    toggleMoreCardsButton();
    addCellClickHandlers();
};
var toggleMoreCardsButton = function () {
    document.querySelector("#add-column").toggleAttribute("disabled");
};
var addCellClickHandlers = function () {
